<template>
  <div>
    ...
    <el-dialog title="编辑" :visible.sync="dialogVisible" width="33%" :close-on-click-modal="false">
      <el-transfer v-model="transferData" :data="allApiData" :props="transferProps" :titles="titles"></el-transfer>
