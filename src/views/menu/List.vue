    ...
    >
      ...
      >
        ...
        <el-form-item label="名称" prop="menuName">
          <el-input
            type="text"
            placeholder="请输入路由组件名称(menuName)"
  ...
  export default {
    ...
    methods: {
      ...
      onNodeDrop(draggingNode, dropNode, dropType) {
        this.$store
          .dispatch("menu/nodeDragDrop", {
            dragNodeId: draggingNode.data.menuId,
            dropNodeId: dropNode.data.menuId,
            dropType
          }).then(data => {
          if (data) {
            this.$message({
