  ...
  <div>
    <el-form :model="formData" label-width="110px" size="mini">
      ...
      <el-form-item label="票价标签">
        <el-select v-model="formData.tag" placeholder="请选择票价标签.." style="width: 100%">
          <el-option label="折扣" value="0"></el-option>
          <el-option label="反点" value="1"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="折扣">
        <el-input v-if="'0'!=formData.tag" v-model="formData.discount" placeholder="请输入反点.."></el-input>
        <el-select v-if="'0'===formData.tag" v-model="formData.discount" placeholder="请选择折扣.." style="width: 100%">
          <el-option
