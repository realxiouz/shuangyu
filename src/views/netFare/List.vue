<template>
  <div class="bigBox">
    ...
    <div class="contentBox">
      ...
      <el-table size="mini" v-loading="loading" :data="tableData" style="width: 100%;margin-bottom: 15px;" fit>
        ...
        <el-table-column label="结束日期" width="300" align="center">
          <template slot-scope="scope">
            ...
            <span>{{initDate(scope.row.endDate,'YYYY-MM-DD')}}</span>
          </template>
        </el-table-column>
      ...
      <el-dialog title="第三方平台账号信息" :visible.sync="dialogVisible" width="30%" :close-on-click-modal="false" center >
        <net-fare-edit
          v-if="dialogVisible"
          :curNode="curNode"
          :update="update"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            loadData() {
                this.$store
                    .dispatch("netFare/getTotal", { filter: {} })
                    .then(data => {
