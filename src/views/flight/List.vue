<template>
  <div class="bigBox">
    ...
    <div class="contentBox">
              ...
              <el-form-item label="经停机场三字码">
                <el-dropdown :hide-on-click="false">
                    <span class="el-dropdown-link">
                      经停机场<i class="el-icon-arrow-down el-icon--right"></i>
                    </span>
      ...
      <el-dialog title="票价信息" center :visible.sync="dialogVisible" width="30%" :close-on-click-modal="false">
        <flightEdit
          v-if="dialogVisible"
          :curNode="curNode"
          :update="update"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            loadData() {
                this.$store
                    .dispatch("flight/getTotal", { filter: {} })
                    .then(data => {
