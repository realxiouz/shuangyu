    ...
    <el-form :model="formData" label-width="120px" size="mini">
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="主航班号">
            <el-input
              type="text"
              v-model="formData.actFlightCode"
              onkeyup="this.value=this.value.toUpperCase()"
              maxlength="2"
              placeholder="主航班号"
            ></el-input>
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="飞行时长">
            <el-input type="text" v-model="formData.flightTimes" placeholder="飞行时长"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="机型全称">
            <el-input
              type="text"
              v-model="formData.flightTypeFullName"
              onkeyup="this.value=this.value.toUpperCase()"
              placeholder="机型全称"
            ></el-input>
          </el-form-item>
      ...
      <el-form-item label="经停机场三字码">
        <el-row>
          ...
          <el-col :span="2">
            <el-button @click="addAirport" style="margin-left: 5px">添加</el-button>
          </el-col>
        </el-row>
      </el-form-item>
      <div class="_tags-view" style="width: 80%;">
        <el-tag
...
export default {
  ...
  methods: {
    ...
    selectArrTime() {
      this.formData.flightTimes = this.computedTime(
        this.formData.dptTime,
        this.formData.arrTime
      );
    },
    computedTime(dptTime, arrTime) {
      ...
      else tmpTime = arrTotalMinutes - dptTotalMinutes;
      if (tmpTime % 60 < 10)
        return "" + Math.floor(tmpTime / 60) + ":0" + (tmpTime % 60);
      else return "" + Math.floor(tmpTime / 60) + ":" + (tmpTime % 60);
    },
    clearForm() {
