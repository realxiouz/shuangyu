<template>
  <div class="app-container">
    ...
    <el-table :data="tableData" style="width: 100%;margin-bottom: 20px;" size="mini">
      ...
      <el-table-column prop="idCardNo" label="身份证号" width="150"></el-table-column>
      <el-table-column label="是否超级管理员" width="150">
        <template slot-scope="scope">
    ...
    ></el-pagination>
    <el-dialog title="用户信息" center :visible.sync="dialogVisible" width="33%" :close-on-click-modal="false">
      <userForm
        v-if="dialogVisible"
        ref="form"
        :userId="userId"
    ...
    handleSearch(params) {
      this.$store
        .dispatch("user/getTotal", {
          filter: params ? { nickName: params.keyword } : {}
        })
        .then(data => {
          this.total = data.data;
        })
