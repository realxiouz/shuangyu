<template>
  <div class="contentBox">
    ...
    <h2>航班信息:</h2>
    <el-table :data="flightData" size="mini" highlight-current-row style="width: 100%;" border fit>
      <el-table-column prop="cabin" label="舱位" width="160"></el-table-column>
      ...
      <el-table-column prop="actFlightCode" label="主航班号" width="80"></el-table-column>
      <el-table-column prop="flightCode" label="航班号" width="100"></el-table-column>
      <el-table-column prop="dpt" label="出发地三字码" width="150"></el-table-column>
      <el-table-column prop="dptAirport" label="出发机场" width="50"></el-table-column>
      <el-table-column prop="dptTerminal" label="出发航楼站" width="80"></el-table-column>
      <el-table-column prop="dptTime" label="起飞时间" width="50"></el-table-column>
      <el-table-column prop="arr" label="到达地三字码" width="100"></el-table-column>
      <el-table-column prop="arrAirport" label="到达机场" width="50"></el-table-column>
      <el-table-column prop="arrTerminal" label="到达航楼站" width="50"></el-table-column>
      <el-table-column prop="arrTime" label="到达时间" width="50"></el-table-column>
      <el-table-column prop="distance" label="航程" width="50"></el-table-column>
      ...
      <el-table-column prop="fuelTax" label="燃油费" width="50"></el-table-column>
      <el-table-column prop="childFuelTax" label="儿童燃油费" width="50"></el-table-column>
      <el-table-column prop="planeType" label="机型" width="50"></el-table-column>
      <el-table-column prop="flightTypeFullName" label="机型全称" width="50"></el-table-column>
      <el-table-column prop="shareFlag" label="共享标记" width="50"></el-table-column>
      <el-table-column prop="stopFlag" label="经停标记" width="50"></el-table-column>
      <el-table-column prop="meal" label="餐食标记" width="50"></el-table-column>
      <el-table-column prop="stopCount" label="经停次数" width="50"></el-table-column>
      <el-table-column prop="cycle" label="飞行周期" width="50"></el-table-column>
      <el-table-column prop="refundRule" label="退票规则" width="50"></el-table-column>
      <el-table-column prop="changeRule" label="改签规则" width="50"></el-table-column>
    </el-table>
