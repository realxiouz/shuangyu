    ...
    <order-search class="page-search" @onSearch="handleSearch"></order-search>
      ...
      >
        ...
        <el-table-column label="交易时间" width="100" align="center">
          <template slot-scope="scope">
            <span>{{
              formatDate(scope.row.transactionTime, "YYYY-MM-DD")
            }}</span>
          </template>
        </el-table-column>
        ...
        <el-table-column label="最晚出票时限" width="100" align="center">
          <template slot-scope="scope">
            <span>{{
              formatDate(scope.row.deadlineTicketTime, "YYYY-MM-DD")
            }}</span>
          </template>
        </el-table-column>
        <el-table-column label="最晚退票时限" width="100" align="center">
          <template slot-scope="scope">
            <span>{{
              formatDate(scope.row.deadlineReturnTime, "YYYY-MM-DD")
            }}</span>
          </template>
        </el-table-column>
        <el-table-column label="最晚改签时限" width="100" align="center">
          <template slot-scope="scope">
            <span>{{
              formatDate(scope.row.deadlineChangeTime, "YYYY-MM-DD")
            }}</span>
          </template>
        </el-table-column>
        <el-table-column
