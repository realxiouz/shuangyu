<template>
  <div>
        ...
        <el-form :model="formData" label-width="110px" size="mini">
          <el-col :xs="24" :sm="12" :md="12" :lg="6" :xl="6">
            <el-form-item label="乘机人姓名:">
              <el-input v-model="formData.passengerName" style="width: 100%;"></el-input>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="12" :lg="6" :xl="6">
          ...
          <el-col :xs="24" v-show="more" :sm="12" :md="12" :lg="6" :xl="6">
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="6" :xl="6">
            <el-form-item v-show="more" label="航班起始日期:">
              <el-col>
                <el-date-picker
                  type="date"
                  placeholder="选择日期"
                  v-model="formData.flightStartDate"
                  style="width: 100%;"
                ></el-date-picker>
              </el-col>
            </el-form-item>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="6" :xl="6">
            <el-form-item v-show="more" label="航班截止日期:">
              <el-col>
                <el-date-picker
                  type="date"
                  placeholder="选择日期"
                  v-model="formData.flightEndDate"
                  style="width: 100%;"
                ></el-date-picker>
              </el-col>
            </el-form-item>
          ...
          <el-col :xs="24" :sm="20" :md="18" :lg="10" :xl="10">
            <el-form-item v-show="more" label="航程类型:">
              <el-radio-group v-model="formData.voyageType">
    ...
    <el-row style="margin-bottom:15px;">
      <el-button type="primary" size="mini" @click="$emit('onAdd')">添加</el-button>
      <span style="margin-left:5px;">订单信息表</span>
    </el-row>
  </div>
</template>
