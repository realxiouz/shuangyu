<template>
  <div class="app-container">
    <tgq-product-search @onSearch="handleSearch" @onAdd="add"></tgq-product-search>
    <el-table :data="tableData" style="width: 100%;margin-bottom: 20px;" border
      ...
      <el-table-column
        ...
        width="300">
        <template slot-scope="scope">
          <el-button v-if="scope.row.status==1" @click="handleStop(scope.row.schedulerId)" type="danger" size="mini">停止</el-button>
