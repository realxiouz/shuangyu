      ...
      <el-table class="page-table" v-loading="loading" :data="tableData" style="width: 100%;" size="mini">
        ...
        <el-table-column fixed="right" label="操作" align="center" width="160">
          <template slot-scope="scope">
            ...
            <el-button @click="skipShipmentOrder(scope.row)" type="text" size="mini" class="btn-danger">配置发货单</el-button>
            <el-button @click="onDel(scope.row)" type="text" size="mini" class="btn-primary">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
