  ...
  <el-container>
    <el-main>
      ...
      <el-dialog title="第三方平台账号信息" :visible.sync="dialogVisible" width="30%" :close-on-click-modal="false">
        <qunar-order-notify-config-edit v-if="dialogVisible" :curNode="curNode" :update="update" :firmList="firmList"
                                        :partyList="partyList"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            loadData() {
                this.$store
                    .dispatch('qunarOrderNotifyConfig/getTotal', {filter: {}})
                    .then(data => {
                ...
                this.$store
                    .dispatch('qunarOrderNotifyConfig/getPageList', {
            ...
            search(keyword) {
                this.$store
                    .dispatch('qunarOrderNotifyConfig/getTotal', {filter: keyword ? {username: keyword} : {}})
                    .then(data => {
                        this.total = data.data;
                    })
                    .catch(error => {
