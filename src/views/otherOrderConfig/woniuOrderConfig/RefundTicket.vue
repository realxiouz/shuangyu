<template>
  <div class="contentBox">
    ...
    >
      ...
      <el-table-column prop="orderStatusDesc" label="订单状态" width="100" align="center"></el-table-column>
      <el-table-column label="订单日期" prop="createTime" width="120" align="center"></el-table-column>
