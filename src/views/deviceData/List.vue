    ...
    <el-table class="page-table" :data="tableData">
      ...
      <el-table-column width="160" label="操作" align="center">
        <template slot-scope="scope">
          <el-button type="text" size="mini" class="btn-primary" @click="onEdit(scope.row.dataId)">编辑</el-button>
          <el-button type="text" size="mini" class="btn-danger" @click="handleDel(scope.row.dataId)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
      ...
      @next-click="onNext"
    ></el-pagination>
    <edit :visible.sync="dialogVisible" :device-id="dataId" @refresh="onRefresh"/>
  </div>
</template>
