        ...
        <el-col :span="24">
          <el-form-item label="项目id" prop="projectId">
            <el-select
              ...
              @change="handleThingsProjectChange"
              placeholder="请选择项目"
              style="width: 100%;"
            >
              <el-option
...
export default {
  ...
  methods: {
    ...
    handleSave() {
      this.$store.dispatch("deviceData/saveOne", this.formData).then(id => {
    ...
    handleThingsProjectChange(val) {
      const item = this.thingsProjectData.find(i => {
