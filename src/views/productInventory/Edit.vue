      ...
      >
        <el-col :xs="24" :sm="12" :md="12" :lg="6" :xl="6">
          <el-form-item :label="item.label">
            ...
            <el-input v-if="propertyList[index].valueType ==0" v-model="item.value"></el-input>
            <!-- 开关-->
            <el-switch v-if="propertyList[index].valueType ==1" v-model="item.value"></el-switch>
            <!-- 数字-->
            <el-input-number
            ...
            ></el-time-picker>
            <!-- 评分-->
            <el-rate v-if="propertyList[index].valueType ==6" v-model="item.value"></el-rate>
            <!-- 单选-->
            <el-radio-group v-if="propertyList[index].valueType ==7" v-model="item.value">
              <el-radio
                v-for="item1 in propertyList[index].values"
                :key="item1.code"
                :label="item1.value"
            ...
            >
              <el-checkbox
                v-for="item2 in propertyList[index].values"
                :key="item2.code"
                :label="item2.value"
              >{{item2.value}}</el-checkbox>
            </el-checkbox-group>
            <!--选择器-->
            <el-select v-model="item.value" v-if="propertyList[index].valueType ==9">
              <el-option
                v-for="item3 in propertyList[index].values"
                :key="item3.code"
                :label="item3.value"
                :value="item3.value"
              ></el-option>
