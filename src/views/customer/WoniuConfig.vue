  ...
  <div class="bigBox">
    ...
    <el-card class="contentBox">
      ...
      <el-form ref="form" :rules="rules" :model="formData" label-width="130px" size="mini">
        <el-row :gutter="10">
          <el-col :xs="24" :sm="24" :md="20" :lg="18" :xl="12">
            <el-form-item label="key:" prop="key">
              <el-input style="width:100%;" v-model="formData.key" @blur="disabledSave"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="10">
        ...
        <el-row>
          <el-col :xs="24" :sm="18" :md="14" :lg="10" :xl="7">
            <el-form-item>
              <el-button @click="save()" type="primary" size="mini" :disabled="isDisable">保存</el-button>
    ...
    removeNotify() {
      if (this.formData && this.formData.domain) {
        this.$confirm("此操作将删除改记录, 是否继续?", "提示", {
          ...
          .then(() => {
            this.$store
              .dispatch("woniuConfig/removeOne", {
