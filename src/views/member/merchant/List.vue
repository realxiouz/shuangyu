<template>
  <div class="page">
    ...
    <el-table class="page-table" highlight-current-row v-loading="loading">
      ...
      <el-table-column label="商户编号" align="center"></el-table-column>
      <el-table-column label="商户名称"  align="center"></el-table-column>
      <el-table-column label="商户类型"  align="center"></el-table-column>
